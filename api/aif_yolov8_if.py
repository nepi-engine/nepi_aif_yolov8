...
class Yolov8AIF(object):
    ...
    def __init__(self, aif_dict,launch_namespace, mgr_namespace, models_lib_path):
      ...
      nepi_ros.log_msg_info("Yolov8 models path: " + self.models_folder_path)
    ...
    def loadModel(self, model_dict):
        ...
        nepi_ros.log_msg_info(self.log_name + ": Launching Yolov8 AI node " + model_name + " with commands: " + str(launch_cmd_line))
    ...
    def killModel(self,model_name):
        if model_name in self.ai_node_dict.keys():
            ...
            nepi_ros.log_msg_info(self.log_name + ": Killing Yolov8 AI node: " + model_name)
